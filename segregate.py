...
import cv2
import tqdm
# files = glob.glob("/home/zafar/old_pc/data_sets/robot-project-datasets/pin_anomaly_data/4-4_lineB/*/*/*/Inputs/*.webp", recursive=True)
...
dest_path = "/home/zafar/old_pc/data_sets/robot-project-datasets/pin_anomaly_data/4-6_lineA"
...
for i, file in enumerate(tqdm.tqdm(files)):
    ...
    if "Front-pin_auto_0" in file:
        ...
        name = os.path.join(dest_path, "Front-pin_auto_0", f"Front-pin_auto_0-{connector_id}.png")
        ...
        name = os.path.join(dest_path, "Front-pin_auto_1", f"Front-pin_auto_1-{connector_id}.png")
        cv2.imwrite(name, img)
        ...
        img = cv2.imread(file)
        connector_id = connector_id.lstrip('0')
        name = os.path.join(dest_path, "Front-pin-2nd_auto_0", f"Front-pin-2nd_auto_0-{connector_id}.png")
        cv2.imwrite(name, img)
        ...
        img = cv2.imread(file)
        connector_id = connector_id.lstrip('0')
        name = os.path.join(dest_path, "Front-pin-2nd_auto_1", f"Front-pin-2nd_auto_1-{connector_id}.png")
        cv2.imwrite(name, img)
        ...
        img = cv2.imread(file)
        connector_id = connector_id.lstrip('0')
        name = os.path.join(dest_path, "Top-pin-2nd_auto_0", f"Top-pin-2nd_auto_0-{connector_id}.png")
        cv2.imwrite(name, img)
        ...
        img = cv2.imread(file)
        connector_id = connector_id.lstrip('0')
        name = os.path.join(dest_path, "Top-pin-2nd_auto_1", f"Top-pin-2nd_auto_1-{connector_id}.png")
        cv2.imwrite(name, img)
        ...
        img = cv2.imread(file)
        connector_id = connector_id.lstrip('0')
        name = os.path.join(dest_path, "Top-pin_auto_0", f"Top-pin_auto_0-{connector_id}.png")
        cv2.imwrite(name, img)
        # shutil.copy(file, os.path.join(dest_path, "Top-pin_auto_0", f"{connector_id}_{os.path.basename(file)}"))
    elif "Top-pin_auto_1" in file:
        img = cv2.imread(file)
        connector_id = connector_id.lstrip('0')
        name = os.path.join(dest_path, "Top-pin_auto_1", f"Top-pin_auto_1-{connector_id}.png")
        cv2.imwrite(name, img)
